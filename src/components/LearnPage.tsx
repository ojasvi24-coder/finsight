...
// Sample articles data - replace with your articles.ts import
        ...
        >
          {filtered.length > 0 ? (
            ...
            >
              ...
              <p className="text-slate-400 mb-2">No articles found matching your search.</p>
        ...
        >
          ...
          <ul className="space-y-3 text-slate-300">
            <li className="flex gap-3">
              ...
              <span>Read articles in order for a complete understanding of wealth-building principles</span>
            </li>
            <li className="flex gap-3">
              <span className="text-emerald-400 font-bold">→</span>
            ...
            <li className="flex gap-3">
              <span className="text-emerald-400 font-bold">→</span>
              <span>Use interactive calculators and simulations to understand the real impact</span>
            </li>
            <li className="flex gap-3">
              <span className="text-emerald-400 font-bold">→</span>
              <span>Revisit articles every 6 months to refresh your knowledge</span>
            </li>
          </ul>
        </motion.div>
      </div>
